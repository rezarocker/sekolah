...
class M_barang extends CI_Model {
	...
	public function get_num_rows($value='')
	{
		...
		$each=$this->db
		->select('MAX(rusak) as rusak')
		->order_by('rusak','DESC')
		->group_by('id_inventaris')
	...
	{
		$select=array('inventaris.nama','ruang.nama_ruang','peminjaman.kode_pinjam','detail_peminjaman.*','peminjaman.tanggal_pinjam','peminjaman.tanggal_kembali','peminjaman.status_peminjaman','pegawai.nama_pegawai');
		...
		->where($where)
		->where('peminjaman.status_peminjaman="TAKEN"')
	...
	{
		$select=array('inventaris.nama','peminjaman.kode_pinjam','detail_peminjaman.*','pegawai.nama_pegawai','peminjaman.tanggal_pinjam','peminjaman.tanggal_kembali','peminjaman.status_peminjaman','pegawai.id_pegawai','petugas.nama_petugas');
		...
		->join('inventaris','inventaris.id_inventaris=detail_peminjaman.id_inventaris','LEFT')
		->join('pegawai','pegawai.id_pegawai=peminjaman.id_pegawai','LEFT')
		->where('peminjaman.id_pegawai',$this->session->id_pegawai)
		->group_by('detail_peminjaman.id_detail_peminjaman');
		if ($where != '') {

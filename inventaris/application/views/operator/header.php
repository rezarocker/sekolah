...
<head>
    ...
    <title>Inventaris - Operator | <?php  echo $title; ?></title>
                    ...
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <div role="menu" class="dropdown-menu message-dd notification-dd animated zoomIn">
                                    ...
                                    <div class="hd-mg-va">
                                        <a href="<?php echo site_url('operator/request/') ?>">View All</a>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a  href="<?php echo site_url('operator/peminjaman'); ?>">Peminjaman</a>
                                </li>
                                <li><a  href="<?php echo site_url('operator/pengembalian'); ?>">Pengembalian</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li <?php echo $title=='Peminjaman' ? 'class="active"':''; ?>><a  href="<?php echo site_url('operator/peminjaman'); ?>"><i class="notika-icon notika-bar-chart"></i> Peminjaman</a>
                        </li>
                        <li <?php echo $title=='Pengembalian' ? 'class="active"':''; ?>><a  href="<?php echo site_url('operator/pengembalian'); ?>"><i class="notika-icon notika-windows"></i> Pengembalian</a>
                        </li>
                        <li <?php echo $title=='Setting' ? 'class="active"':''; ?>><a  href="<?php echo site_url('operator/setting'); ?>"><i class=""></i> Setting</a>
                        </li>

(function ($) {
 "use strict";
		...
		$("body").on("change", ".nk-int-st .form-control", function() {
            $(this).closest(".nk-int-st").addClass("nk-toggled")
        })
		$(".nk-int-st")[0] && ($("body").on("focusin", ".nk-int-st .form-control", function() {
            $(this).closest(".nk-int-st").addClass("nk-toggled")
        }), $("body").on("focusout", ".form-control", function() {
            var p = $(this).closest(".form-group, .input-group"),
                i = p.find(".form-control").val();
                i.length == 0 ? $(this).closest(".nk-int-st").removeClass("nk-toggled"):'';
            p.hasClass("fg-float") ? 0 == i.length && $(this).closest(".nk-int-st").removeClass("nk-toggled") : '';	
        })
